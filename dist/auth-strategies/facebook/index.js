...
exports.default = {
    load: (container, configModule, options) => {
        ...
        if ((_a = options.facebook) === null || _a === void 0 ? void 0 : _a.admin) {
            new admin_1.FacebookAdminStrategy(container, configModule, options.facebook, options.strict);
        }
        if ((_b = options.facebook) === null || _b === void 0 ? void 0 : _b.store) {
            new store_1.FacebookStoreStrategy(container, configModule, options.facebook, options.strict);
        }
    },
